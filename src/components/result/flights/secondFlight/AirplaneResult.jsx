...
const AirplaneResult = () => {
  ...
  const date = window.localStorage.getItem('FlightDateCome').replace(/"/g, '')
  ...
  useEffect(() => {
    window.localStorage.setItem('AIRPLAINIDSECOND', JSON.stringify(clickedItem))
  }, [clickedItem])

  const handleNameChange = (e) => {
    window.location.href = '/airplanepays'
