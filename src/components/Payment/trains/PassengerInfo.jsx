...
const PassengerInfo = () => {
  ...
  useQuery(trainQueries.SEARCHTRAINBYID, {
    ...
    onCompleted: (res) => {
      setPrice2(res.searchTrainbyId.price)
    },
    onError: () => {
      setPrice2([])
    }
