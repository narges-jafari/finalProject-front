    ...
    <>
      ...
      <div className='d-flex flex-column w-75 ' style={{ margin: '0px auto 20px auto' }}>
        ...
        <div className={styles.item}>
          ...
          <span>5</span>
          <p className={styles.ptext}>
            وب‌سایت تریپنو به فروش اینترنتی بلیط هواپیما می‌پردازد و در قبال شرایط اضطراری (بدی آب و هوا، بلایای طبیعی و غیره)، کنسلی، تاخیر یا تعجیل پرواز و یا اعلام ورشکستگی کلیه ی ایرلاینها  مسئولیتی را بر عهده نخواهد داشت و کلیه مسولیت ها بر عهده‌ی شرکتهای هواپیمایی مجری پرواز است.
          </p>
          <p />
        </div>
      </div>
