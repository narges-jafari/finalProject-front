      ...
      <div className='d-flex flex-column '>
        <div className='d-flex flex-row flex-wrap my-2 justify-content-between'>
          ...
          <div className='d-flex flex-row flex-wrap  justify-content-between mx-2'>
            <i className='fa fa-plus btn btn-primary   fa-lg mx-2 ' onClick={e => { setNum(num + 1); props.AllPassenger(num) }} style={{ width: '25px', height: '25px', borderRadius: '50%', textAlign: 'center', padding: '7px 0px 0px 0px', color: 'white' }} />
        ...
        <div className='d-flex flex-row justify-content-around'>
          <button value='اکونومی' onClick={e => { setName(e.target.value); props.AllClass(e.target.value) }} style={{ width: '80px' }} className='btn btn-sm btn-primary my-1'> اکونومی </button>
          <button style={{ width: '80px' }} value='  پرمیوم' onClick={e => { setName(e.target.value); props.AllClass(e.target.value) }} className='btn btn-sm btn-primary my-1'> پرمیوم </button>
        </div>
        <div className='d-flex flex-row justify-content-around'>
          <button style={{ width: '80px' }} value='  بیزینس' onClick={e => { setName(e.target.value); props.AllClass(e.target.value) }} className='btn btn-sm btn-primary my-1'> بیزینس </button>
          <button style={{ width: '80px' }} value='فرست' onClick={e => { setName(e.target.value); props.AllClass(e.target.value) }} className='btn btn-sm btn-primary my-1'> فرست </button>
...
export default AirplanePassenger
